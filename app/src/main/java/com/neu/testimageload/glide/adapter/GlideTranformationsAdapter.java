package com.neu.testimageload.glide.adapter;
...
import com.neu.testimageload.picasso.Utils;
...
//                        .apply(bitmapTransform(new CenterCrop(), new MaskTransformation(mContext,R.drawable.mask_starfish)))
//                        .into(holder.image);
//                break;
//            }
//            case 2: {
...
//            case 20:
//                Glide.with(mContext)
//                        .load(R.drawable.check).transform(new KuwaharaFilterTransformation(mContext, 25))
//                        .bitmapTransform()
//                        .into(holder.image);
//                break;
//            case 21:
