package com.neu.testimageload.VideoRecordDemo;
...
public class VideoRecordDemoActivity extends AppCompatActivity implements View.OnClickListener {
...
//    private boolean isPause; //暂停标识
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_record_demo);
        initView();
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    VideoUtils.appendVideo(VideoRecordDemoActivity.this, getSDPath(VideoRecordDemoActivity.this) + "append.mp4", str);
                    File reName = new File(saveVideoPath);
                    File f = new File(getSDPath(VideoRecordDemoActivity.this) + "append.mp4");
            ...
            case R.id.record_control: {
                if (mRecorderState == STATE_INIT) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent intent = new Intent(VideoRecordDemoActivity.this, PlayVideoActivity.class);
                ...
                if (mRecorderState == STATE_RECORDING) {
                    ...
                    mCamera.autoFocus(new Camera.AutoFocusCallback() {
                        ...
                        public void onAutoFocus(boolean success, Camera camera) {
                            if (success)
                                VideoRecordDemoActivity.this.mCamera.cancelAutoFocus();
                        }
                    });
